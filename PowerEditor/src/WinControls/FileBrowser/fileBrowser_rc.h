...
#define	IDD_FILEBROWSER_MENU		(IDD_FILEBROWSER + 10)
  ...
  #define IDM_FILEBROWSER_CREATEFILE       (IDD_FILEBROWSER_MENU + 11)
  #define IDM_FILEBROWSER_RENAMEFILE       (IDD_FILEBROWSER_MENU + 12)
  #define IDM_FILEBROWSER_DELETEFILE       (IDD_FILEBROWSER_MENU + 13)

#define	IDD_FILEBROWSER_CTRL		(IDD_FILEBROWSER + 30)
  #define	ID_FILEBROWSERTREEVIEW    (IDD_FILEBROWSER_CTRL + 1)
  #define IDC_FILENAME_EDIT           (IDD_FILEBROWSER_CTRL + 2)
#define IDD_NEW_FILE_NAME_DIALOG    (IDD_FILEBROWSER + 40)
